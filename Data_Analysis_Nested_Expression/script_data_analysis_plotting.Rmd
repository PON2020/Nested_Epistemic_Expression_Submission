...
# the prior has a mean of -0.2 (the estimate from the previous model)
# the sd of the prior varies but not smaller than 1, thus not too informative
prior_list_bf = c('normal(-0.2, 10)', 'normal(-0.2, 5)','normal(-0.2, 1)')
...
# create latex table
row.names(tab_bf_analysis) <- c('Prior', 'Estimate', 'BF01')
...
# create a list of uninformative prior for slope
# the prior has a mean of -0.12 (the estimate from the previous model)
# the sd of the prior varies but not smaller than 1, thus not too informative
prior_list_bf_2 = c('normal(-0.12, 10)', 'normal(-0.12, 5)','normal(-0.12, 1)')
# create an empty data frame to store the output of bf analysis
...
# the coefficient of condition is zero
# create latex table
row.names(tab_bf_analysis_2) <- c('Prior', 'Estimate', 'BF01')
...
# the sd of the prior varies but not smaller than 1, thus not too informative
prior_list_bf_3 = c('normal(0.01, 10)', 'normal(0.01, 5)','normal(0.01, 1)')
# create an empty data frame to store the output of bf analysis
...
# the coefficient of condition is zero
# create latex table
row.names(tab_bf_analysis_3) <- c('Prior', 'Estimate', 'BF01')
